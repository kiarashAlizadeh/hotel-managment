...
function Footer() {
  return (
    <>
      <footer className="flex w-full select-none flex-col bg-[#14274A] pb-3 pt-5 text-white">
          ...
          <div className="flex w-full flex-wrap items-center gap-5 sm:justify-between">
            <span>
              <span className="flex max-w-[350px] flex-col gap-y-4 text-justify leading-7">
                ...
                هتل پارسیان آزادی، با تاریخ درخشان و خدمات بی‌نظیر، در قلب تهران
                واقع شده است. زیرساخت‌های مدرن، امکانات رفاهی و خدمات با کیفیت،
                تضمین کننده‌ی یک اقامت لذت‌بخش است. از طراحی شیک تا رستوران‌های
                متنوع، هر جزئیاتی در اینجا برای راحتی شما در نظر گرفته شده است.
              </span>
            ...
            <div className="flex gap-10">
              <ul className="flex flex-col items-start gap-1 sm:items-center">
                <li className="mb-2 font-black">امکانات و خدمات</li>
                <li>
              ...
              <ul className="flex flex-col items-start gap-1 sm:items-center">
                <li className="mb-2 font-black">صفحات</li>
                <li>
        ...
        >
          <span>©2023 Parsian Azadi Hotel, Inc. All Rights Reserved.</span>
